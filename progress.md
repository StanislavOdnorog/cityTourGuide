...
Этот файл используется агентами для логирования прогресса по задачам из корневого `tasks.json`. Актуальность структуры и статусов можно проверить командой `make verify-planning`.
